...
class MovieCard extends StatelessWidget {
  ...
  /// When true, uses ScreenUtil sizing.
  /// When false, uses StackFit.expand sizing.
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            // Gradient overlay (expand mode only)
            if (!useContextSize)
              ClipRRect(
                borderRadius: BorderRadius.circular(borderRadius),
                child: Container(
            ...
            // Title (optional, expand mode only)
