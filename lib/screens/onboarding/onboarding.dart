     ...
     return PageView.builder(
      ...
      body:  Stack(
        ...
        Align(
          ...
          child: OnboardingBottomsheet(bottomSheetTitle: data.title,
  ...
  Widget firstPagt(OnboardingData data) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Spacer(flex: 2),
          Text(data.title, style: AppStyles.medium36white, textAlign: TextAlign.center),
          Text(data.description, style: AppStyles.bold20White, textAlign: TextAlign.center),
