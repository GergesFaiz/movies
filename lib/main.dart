...
import 'package:movies/tabs/HomeTab/home_tab_view_model.dart';
import 'package:movies/tabs/ProfileTab/updateprofile/update_profile_screen.dart';
              ...
              AppRoutes.homeScreen: (context) =>
                  MultiBlocProvider(
                    providers: [
                      ...
                      BlocProvider(create: (_) => HomeTabViewModel()),
                    ],
                    child: HomeScreen(),
                  ),
